...
struct Quotes : Codable {
    ...
    let USDBBD: Double? // Barbadian Dolla>
    let USDBDT: Double? // Bangladeshi Tak>
    ...
    let USDBOB: Double? // Bolivian Bolivion
    let USDBRL: Double? // Brazilian Real
    let USDBSD: Double? // Bahamian Dollar
    let USDBTN: Double? // Bhutanese Ngulton
    let USDBWP: Double? // Botswanan Pula
    let USDBYR: Double? // Belarusian Rubl
    ...
    let USDGTQ: Double? // Guatemalan Quetza
    ...
    let USDKYD: Double? // Cayman Islands Doion
    ...
    let USDMRO: Double? // Mauritanian Ouguin>
    ...
    let USDNIO: Double? // Nicaraguan CÃ³rdoba
    ...
    let USDSTD: Double? // SÃ£o TomÃ© and PrÃ­ncipe Dobra
    let USDSVC: Double? // Salvadoran ColÃ³n
    ...
    let USDVEF: Double? // Venezuelan BolÃ­var
    ...
    let USDZMK: Double? // Zambian Kwacha
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case USDBBD = "USDBBD" // Barbadian Dolla>
        case USDBDT = "USDBDT" // Bangladeshi Tak>
        ...
        case USDBOB = "USDBOB" // Bolivian Bolivion
        case USDBRL = "USDBRL" // Brazilian Real
        case USDBSD = "USDBSD" // Bahamian Dollar
        case USDBTN = "USDBTN" // Bhutanese Ngulton
        case USDBWP = "USDBWP" // Botswanan Pula
        case USDBYR = "USDBYR" // Belarusian Rubl
        ...
        case USDGTQ = "USDGTQ" // Guatemalan Quetza
        ...
        case USDKYD = "USDKYD" // Cayman Islands Doion
        ...
        case USDMRO = "USDMRO" // Mauritanian Ouguin>
        ...
        case USDNIO = "USDNIO" // Nicaraguan CÃ³rdoba
        ...
        case USDSTD = "USDSTD" // SÃ£o TomÃ© and PrÃ­ncipe Dobra
        case USDSVC = "USDSVC" // Salvadoran ColÃ³n
        ...
        case USDVEF = "USDVEF" // Venezuelan BolÃ­var
        ...
        case USDZMK = "USDZMK" // Zambian Kwacha
